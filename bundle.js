...
/***/ function(module, exports, __webpack_require__) {
	...
	var _view3 = __webpack_require__(164);

	var _view4 = _interopRequireDefault(_view3);

	var _leftPanel = __webpack_require__(169);

	var _leftPanel2 = _interopRequireDefault(_leftPanel);

	var _asteroidsView = __webpack_require__(170);
	...
	document.addEventListener("DOMContentLoaded", function () {
	  ...
	  _reactDom2.default.render(_react2.default.createElement(MainView, null), root);
	});
	...
	var TetrisView = function (_React$Component) {
	  ...
	  _createClass(TetrisView, [{
	    ...
	    value: function boardRender() {
	      ...
	      var board = this.state.game.board.grid.map(function (row, rowidx) {
	        var units = row.map(function (unit, colidx) {
	          ...
	          return _react2.default.createElement('div', { className: 'tetrisUnit ' + additionClass + ' ' + unit.filled, key: '' + colidx });
	        });

	        return _react2.default.createElement(
	          'div',
	          { className: 'tetrisRow', key: '' + rowidx },
	          units
	        );
	      });
	      return board;
	    ...
	    value: function render() {
	      ...
	      if (this.state.status === "firstGame") {
	        gameStatus = _react2.default.createElement('div', { className: 'firstGame' });
	        this.addListener();
	      } else if (this.state.status === "notRunning") {
	        gameStatus = _react2.default.createElement('div', { className: 'gameOver' });
	        this.addListener();
	      }
	      ...
	      if (this.state.game) {
	        rightPanel = _react2.default.createElement(_rightPanel2.default, { board: this.state.game.board.makeNextPieceSceen.bind(this),
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _piece = __webpack_require__(162);
	  ...
	  _createClass(Game, [{
	    ...
	    value: function pauseGame() {
	      ...
	      document.addEventListener('keydown', function (e) {
	        if (e.keyCode == 32 && _this6.running) {
	          e.preventDefault();
	          _this6.running = false;
	          document.removeEventListener('keydown', _this6.keyListener);
	          clearInterval(_this6.interval);
	        } else if (e.keyCode == 32 && _this6.running === false) {
	          e.preventDefault();
	          _this6.running = true;
	          _this6.addListeners();
	...
	var Board = function () {
	  ...
	  _createClass(Board, [{
	    ...
	    value: function resetGrid() {
	      ...
	      this.grid[23].forEach(function (el) {
	        el.filled = "black";
	      });
	      this.grid[24].forEach(function (el) {
	        el.filled = "black";
	      });
	    }
...
/***/ function(module, exports) {
	...
	var Piece = function () {
	  ...
	  _createClass(Piece, [{
	    ...
	    key: 'pieceScreenPos',
	    value: function pieceScreenPos() {
	      var pos = this.startPos.map(function (pos) {
	...
	var RightPanel = function (_React$Component) {
	  ...
	  _createClass(RightPanel, [{
	    ...
	    value: function nextPiece() {
	      ...
	      var nextPieceScreen = this.props.board().map(function (row, rowidx) {
	        var units = row.map(function (unit, colidx) {

	          var additionClass = void 0;
	          _this2.props.nextPiece.pieceScreenPos().forEach(function (el) {
	            if (el[0] === rowidx && el[1] === colidx) {
	              additionClass = _this2.props.nextPieceFillColor;
	            }
	          });
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _intro_panel = __webpack_require__(168);

	var _intro_panel2 = _interopRequireDefault(_intro_panel);
	...
	var SnakeView = function (_React$Component) {
	  _inherits(SnakeView, _React$Component);

	  function SnakeView(props) {
	    _classCallCheck(this, SnakeView);

	    var _this = _possibleConstructorReturn(this, (SnakeView.__proto__ || Object.getPrototypeOf(SnakeView)).call(this, props));
	  ...
	  _createClass(SnakeView, [{
	    ...
	    key: 'makeInitialGame',
	    value: function makeInitialGame() {
	      if (this.state.showWhichView === "firstGame") {
	        this.setState({
	          game: new _game2.default(this),
	    ...
	    value: function renderGame() {
	      ...
	      var board = this.state.game.board.grid.map(function (row, rowidx) {
	        var units = row.map(function (unit, colidx) {
	          ...
	          var snakePos = _this3.state.game.snake.pos;
	          ...
	          if (_this3.state.game.lost === "wall" && snakePos[1][0] === rowidx && snakePos[1][1] === colidx) {
	            snakeClass = "snake head";
	          } else if (snakePos[0][0] === rowidx && snakePos[0][1] === colidx) {
	            snakeClass = "snake head";
	          }

	          var fruitPos = _this3.state.game.fruit;
	          if (fruitPos[0] === rowidx && fruitPos[1] === colidx) {
	            fruitClass = "fruit";
	            fruitType = _this3.state.game.fruitType;
	          }

	          return _react2.default.createElement('div', { className: 'snakeUnit ' + snakeClass + ' ' + fruitClass + ' ' + fruitType, key: '' + colidx });
	        });

	        return _react2.default.createElement(
	          'div',
	          { className: 'snakeRow', key: '' + rowidx },
	          units
	        );
	      });
	      return _react2.default.createElement(
	    ...
	    value: function render() {
	      ...
	      if (this.state.showWhichView === 'notRunning' || this.state.showWhichView === 'firstGame') {
	        currentView = _react2.default.createElement(_intro_panel2.default, {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _board = __webpack_require__(166);

	var _board2 = _interopRequireDefault(_board);

	var _snake = __webpack_require__(167);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var IntroPanel = function (_React$Component) {
	  _inherits(IntroPanel, _React$Component);

	  function IntroPanel(props) {
	    _classCallCheck(this, IntroPanel);

	    var _this = _possibleConstructorReturn(this, (IntroPanel.__proto__ || Object.getPrototypeOf(IntroPanel)).call(this, props));

	    _this.state = { panel: _this.addEventListener() };
	    return _this;
	  }

	  _createClass(IntroPanel, [{
	    key: 'componentWillUnmount',
	    value: function componentWillUnmount() {
	    ...
	    value: function render() {
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement('div', { className: 'snakeIntro' }),
	        _react2.default.createElement(
	          'div',
	          { className: 'bottom' },
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Images = __webpack_require__(171);
	var Game = __webpack_require__(172);

	var AsteroidsView = function (_React$Component) {
	  _inherits(AsteroidsView, _React$Component);

	  function AsteroidsView(props) {
	    _classCallCheck(this, AsteroidsView);

	    var _this = _possibleConstructorReturn(this, (AsteroidsView.__proto__ || Object.getPrototypeOf(AsteroidsView)).call(this, props));

	    _this.state = { game: undefined,
	      status: "firstGame"
	    };
	    return _this;
	  }

	  _createClass(AsteroidsView, [{
	    key: 'componentWillUnmount',
	    value: function componentWillUnmount() {
	      if (this.state.game) {
	        this.endGame();
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Collidable = __webpack_require__(173);
	var Ship = __webpack_require__(175);
	var Bullet = __webpack_require__(176);
	var Asteroid = __webpack_require__(177);
	var Explosion = __webpack_require__(178);
	var Description = __webpack_require__(179);
	...
	var Game = function () {
	  ...
	  _createClass(Game, [{
	    ...
	    key: 'makeLargeAsteroid',
	    value: function makeLargeAsteroid() {
	    ...
	    key: 'makeSmallAsteroid',
	    value: function makeSmallAsteroid(pos) {
	      for (var i = 0; i < 4; i++) {
	        var asteroid = new Asteroid({
	          position: pos,
	          direction: [-1, -1],
	    ...
	    key: 'makeExplosion',
	    value: function makeExplosion(asteroid) {
	    ...
	    key: 'makeWarp',
	    value: function makeWarp(asteroid) {
	      var explosion = new Explosion({
	        position: asteroid.position,
	        direction: asteroid.direction,
	        vector: [asteroid.vector[0] / 4, asteroid.vector[1] / 4],
	    ...
	    key: 'concatAll',
	    value: function concatAll() {
	      this.allObjects = [].concat(this.ship, this.bullets, this.asteroids, this.explosions);
	    }
	  }, {
	    key: 'beforeMoveAll',
	    value: function beforeMoveAll() {
	      this.allObjects.forEach(function (circle) {
	        return circle.beforeMove();
	      });
	    }
	  }, {
	    key: 'moveAll',
	    ...
	    key: 'drawAllImages',
	    value: function drawAllImages() {
	      this.allObjects.forEach(function (circle) {
	        return circle.drawImage();
	      });
	    }
	  }, {
	    key: 'clear',
	    ...
	    key: 'detectBulletAsteroidCollision',
	    value: function detectBulletAsteroidCollision() {
	      var _this = this;
	        ...
	        _this.bullets.forEach(function (bullet) {
	          if (asteroid.collideWith(bullet)) {
	            if (asteroid.radius === 60) {
	              _this.makeExplosion(asteroid);
	              _this.makeSmallAsteroid(asteroid.position);
	              _this.remove(asteroid);
	              _this.score += 100;
	            } else {
	              _this.makeExplosion(asteroid);
	              _this.remove(asteroid);
	    ...
	    key: 'detectShipAsteroidCollision',
	    value: function detectShipAsteroidCollision() {
	      var _this2 = this;

	      this.asteroids.forEach(function (asteroid) {
	        if (asteroid.collideWith(_this2.ship[0]) && _this2.running) {
	          if (asteroid.radius === 60) {
	            _this2.makeExplosion(asteroid);
	            _this2.makeSmallAsteroid(asteroid.position);
	            _this2.remove(asteroid);
	          } else {
	            _this2.makeExplosion(asteroid);
	            _this2.remove(asteroid);
	          }
	          _this2.ship[0].shipLives -= 1;
	          _this2.makeExplosion(_this2.ship[0]);
	          _this2.checkGameLost();
	        }
	      });
	    }
	  }, {
	    key: 'resetGame',
	    value: function resetGame(endGame) {
	      this.localStorageScore();
	      this.bullets = [];
	      this.allObjects = [];
	      this.explosions = [];
	    ...
	    key: 'detectAllCollisions',
	    value: function detectAllCollisions() {
	    ...
	    key: 'resetFieldAsteroidsAfterRound',
	    value: function resetFieldAsteroidsAfterRound() {
	    ...
	    key: 'makeStartScreenAndGameDesciptions',
	    value: function makeStartScreenAndGameDesciptions() {
	    ...
	    key: 'setGameIntoMotion',
	    value: function setGameIntoMotion() {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Images = __webpack_require__(171);
	var ImageSpec = __webpack_require__(174);

	var Collidable = function () {
	  function Collidable(params) {
	  ...
	  _createClass(Collidable, [{
	    key: 'collideWith',
	    value: function collideWith(otherCollidable) {
	      var xDiff = this.position[0] - otherCollidable.position[0];
	      var yDiff = this.position[1] - otherCollidable.position[1];

	      var distanceBetween = Math.sqrt(Math.pow(xDiff, 2) + Math.pow(yDiff, 2));
	    ...
	    key: 'generateRandomFrameRate',
	    value: function generateRandomFrameRate() {
	      return Math.floor(8 * Math.random() + 1);
	    }
	  }, {
	    key: 'makeImageSpecs',
	    value: function makeImageSpecs() {
	      if (this.image) {
	    ...
	    value: function drawImage() {
	      if (this.image) {
	        ...
	        this.context.drawImage(this.imageSource, this.frameX, this.frameY, this.frameWidth, this.frameHeight, this.imageSpec.shipOffset || this.position[0] - this.imageSpec.offset, this.imageSpec.shipOffset || this.position[1] - this.imageSpec.offset, this.imageWidth, this.imageHeight);
	    ...
	    key: 'terminateAfterAnimation',
	    value: function terminateAfterAnimation() {
	      this.game.remove(this);
	    }
	  }, {
	    key: 'move',
	    value: function move() {
	      this.position = [(this.position[0] + this.vector[0] + this.context.canvas.width) % this.context.canvas.width, (this.position[1] + this.vector[1] + this.context.canvas.height) % this.context.canvas.height];
	    }
	  }, {
	    key: 'beforeMove',
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Ship = function (_Collidable) {
	  _inherits(Ship, _Collidable);
	  ...
	  function Ship(params) {
	    ...
	    _this.rotationState = ROTATION_STATE.NONE;
	    _this.shipStatus = SHIP_STATUS.BLINKING;
	    _this.shipImpulse = SHIP_STATUS.NOIMPULSE;
	    _this.invulnerabilityCounter = 70;
	    _this.shipLives = 1;
	    _this.addListener();
	    return _this;
	  }
	  ...
	  _createClass(Ship, [{
	    key: 'invulnerability',
	    value: function invulnerability() {
	    ...
	    value: function rotateShip() {
	      ...
	      this.direction = [Math.cos(this.rotation), Math.sin(this.rotation)];
	    }
	  }, {
	    key: 'addListener',
	    value: function addListener() {
	      ...
	      var listenersFn = function listenersFn(e) {
	        if (e.key === " " && _this2.game.running) {
	          ...
	          if (e.type === 'keydown') {
	            ...
	            _this2.shipImpulse = SHIP_STATUS.IMPULSE;
	          } else {
	    ...
	    key: 'updateVector',
	    value: function updateVector(speed) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Bullet = function (_Collidable) {
	  _inherits(Bullet, _Collidable);

	  function Bullet(params) {
	    _classCallCheck(this, Bullet);

	    var _this = _possibleConstructorReturn(this, (Bullet.__proto__ || Object.getPrototypeOf(Bullet)).call(this, params));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Asteroid = function (_Collidable) {
	  _inherits(Asteroid, _Collidable);

	  function Asteroid(params) {
	    _classCallCheck(this, Asteroid);

	    var _this = _possibleConstructorReturn(this, (Asteroid.__proto__ || Object.getPrototypeOf(Asteroid)).call(this, params));

	    _this.position = _this.position || _this.generateRandomPos();
	    _this.vector = _this.generateRandomVector();
	    return _this;
	  }

	  _createClass(Asteroid, [{
	    key: 'generateRandomPos',
	    value: function generateRandomPos() {
	      return [this.game.canvas.width * Math.random(), this.game.canvas.height * Math.random()];
	    }
	  }, {
	    key: 'checkRandomShipAsteroidCollision',
	    value: function checkRandomShipAsteroidCollision() {
	      this.radius += 100;
	    ...
	    value: function generateRandomVector() {
	      return [this.vector[0] * Math.random() - this.vector[0] / 2, this.vector[1] * Math.random() - this.vector[1] / 2];
	    }
	  }]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Explosion = function (_Collidable) {
	  _inherits(Explosion, _Collidable);

	  function Explosion(params) {
	    _classCallCheck(this, Explosion);

	    return _possibleConstructorReturn(this, (Explosion.__proto__ || Object.getPrototypeOf(Explosion)).call(this, params));
	  }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Description = function () {
	  ...
	  _createClass(Description, [{
	    key: "drawShipLivesAndScore",
	    value: function drawShipLivesAndScore() {
	      var xPos = 770;
	      var highScore = "";
	      for (var i = 0; i < this.game.ship[0].shipLives; i++) {
	        this.game.context.drawImage(Images.ship, 0, 0, 96, 156, xPos, 15, 24, 39);
	        xPos -= 40;
	      }
	    ...
	    key: "makeEnterScreen",
	    value: function makeEnterScreen() {
	      var _this = this;

	      var listenerFn = function listenerFn(e) {
	        if (e.keyCode === 13) {
	          _this.game.running = true;
	          if (_this.game.ship[0]) {
	            _this.game.ship[0].image = Images.ship;
	            _this.game.resetGame();
	          }
	          _this.enterListener = document.removeEventListener('keydown', listenerFn);
	        }
	      };

	      if (!this.startGame) {
	        this.game.ship[0].image = undefined;
	        this.game.context.drawImage(Images.asteroidintro, 0, 0, 583, 519, 130, 60, 583, 519);
	    ...
	    key: "drawGameDescriptions",
	    value: function drawGameDescriptions() {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var YeZhu = function (_React$Component) {
	  ...
	  function YeZhu(props) {
	    _classCallCheck(this, YeZhu);

	    return _possibleConstructorReturn(this, (YeZhu.__proto__ || Object.getPrototypeOf(YeZhu)).call(this, props));
	  }
